        ...
        <div className="group">
            ...
            <div className="produk_terbaru">
                <div className="gallery">
                    <a href="../detail/Detail"><img src="/assets/2.jpg" alt=""/></a>
                    ...
                    <a href=""><img src="/assets/6.jpg" alt=""/></a>
                    <a href=""><img src="/assets/7.jpg" alt=""/></a>
                    <a href=""><img src="/assets/8.jpg" alt=""/></a>
                    <a href=""><img src="/assets/9.jpg" alt=""/></a>
                </div>
                <div className="btn">
                    <a href="javascript:void();" className="readmore-btn">See More</a>
                </div>
            </div>
            <div className="pembungkus">
                <h1><strong>Recomended for you and your loved ones</strong></h1>
            </div>
            <ul className="thumbnail">
                <li>
                    ...
                    <div className="content">
                        ...
                        <p>Pilih 1 Layanan dari kategori ini yang ingin ditaruh disini. Pilih 1 layanan dari kategori ini yang ingin di tatuh disini.</p>
                    </div>
                </li>
                <li>
                    ...
                    <div className="content">
                        ...
                        <p>Pilih 1 layanan dari kategori ini yang ingin ditaruh di sini. Pilih 1 layanan dari kategori ini yang ingin di taruh disini</p>
                    </div>
                </li>
                <li>
                    ...
                    <div className="content">
                        ...
                        <p>Pilih 1 layanan dari kategori ini yang ingin ditaruh disini. Pilih 1 layanan dari kategori ini yang ingin ditaruh disini.</p>
                    </div>
                </li>
                <li>
